...
export default function CartPage() {
  const { items, loaded, subtotal, updateQuantity, removeItem } = useCart();
  if (!loaded) return <section className="cart-page"><div className="loading-state"><span className="loading-line" /><span className="loading-line short" /><span className="loading-block" /></div></section>;
