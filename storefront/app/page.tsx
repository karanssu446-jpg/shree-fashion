    ...
    return <>
      ...
      <section className="testimonial-section">
        ...
        <div className="testimonial-grid">
          <div className="testimonial-card"><div className="testimonial-stars">★★★★★</div><p>The fabric quality is so much better than what I usually find online. My kurta set fit perfectly and the colours look exactly like the photos.</p><div className="testimonial-person"><img className="testimonial-avatar" src="/customer_1.webp" alt="Priya M." loading="lazy" /><div><strong>Priya M.</strong><span>Jaipur</span></div></div></div>
          <div className="testimonial-card"><div className="testimonial-stars">★★★★★</div><p>Ordered a co-ord set for a family function and got so many compliments. Delivery was quick and the packaging felt genuinely premium.</p><div className="testimonial-person"><img className="testimonial-avatar" src="/customer_2.webp" alt="Ananya R." loading="lazy" /><div><strong>Ananya R.</strong><span>Delhi</span></div></div></div>
          <div className="testimonial-card"><div className="testimonial-stars">★★★★★</div><p>Shree Fashion is now my go-to for festive wear. The embroidery detailing is beautiful and true to the pictures on the site.</p><div className="testimonial-person"><img className="testimonial-avatar" src="/customer_3.webp" alt="Kavita S." loading="lazy" /><div><strong>Kavita S.</strong><span>Mumbai</span></div></div></div>
        </div>
      </section>
